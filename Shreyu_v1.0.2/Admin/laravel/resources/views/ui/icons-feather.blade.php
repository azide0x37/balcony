...
<div class="row page-title">
    <div class="col-md-12">
        ...
        <h4 class="mb-1 mt-0">Feather Icons</h4>
    </div>
</div>
@endsection
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <p class="mb-3">Use <code>&lt;i data-feather="activity" class="icons-**"&gt;&lt;/i&gt;</code>. Available sizes <code>sm,lg,xl,xxl</code></p>
                ...
                <div class="row icons-list">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="icon-item">
                            <i data-feather="airplay" class="icon-xs icon-dual"></i>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="icon-item">
                            <i data-feather="airplay" class="icon-sm icon-dual"></i>
                            <span>Small</span>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="icon-item">
                            <i data-feather="airplay" class="icon-lg icon-dual"></i>
                            <span>Large</span>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="icon-item">
                            <i data-feather="airplay" class="icon-xl icon-dual"></i>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="icon-item">
                            <i data-feather="airplay" class="icon-xxl icon-dual"></i>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row icons-list">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="icon-item">
                            <i data-feather="airplay" class="icon-dual-success"></i>
                            <span>airplay</span>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="icon-item">
                            <i data-feather="alert-circle" class="icon-dual-danger"></i>
                            <span>alert-circle</span>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="icon-item">
                            <i data-feather="alert-octagon" class="icon-dual-info"></i>
                            <span>alert-octagon</span>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="icon-item">
                            <i data-feather="anchor" class="icon-dual-dark"></i>
                            <span>anchor</span>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="icon-item">
                            <i data-feather="aperture" class="icon-dual-primary"></i>
                            <span>aperture</span>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="icon-item">
                            <i data-feather="archive" class="icon-dual-success"></i>
                            <span>archive</span>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="icon-item">
                            <i data-feather="clock" class="icon-dual-danger"></i>
                            <span>clock</span>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="icon-item">
                            <i data-feather="shopping-bag" class="icon-dual-info"></i>
                            <span>shopping-bag</span>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="icon-item">
                            <i data-feather="printer" class="icon-dual-warning"></i>
                            <span>printer</span>
                        </div>
                    </div>
                </div>
